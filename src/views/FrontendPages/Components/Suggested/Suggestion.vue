      ...
      <b-row>
         <b-col sm="12" class="overflow-hidden">
            ...
            <div class="suggestede-contens">
               <Slick class="list-inline favorites-slider row p-0 mb-0" :option="suggestionSliderOption">
                  <li class="slide-item" v-for="(item,index) in suggestionList" :key="index">
...
export default {
  ...
  computed: {
    ...
    suggestionList () {
      let cmapItem = this.cmapList.suggest
      let sugList = []
